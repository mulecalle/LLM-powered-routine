  ...
  themeConfig: {
    ...
    sidebar: [{
        ...
        items: [
            ...
            { text: 'Day 2 - PIERNAS Y HOMBROS', link: '/month/26/jul/d2' },
            { text: 'Day 3 - ESPALDA Y TRICEPS', link: '/month/26/jul/d3' },
        ]
        },{
        text: '2026 - June',
        items: [
            { text: 'Day 1 - PECHO Y BICEPS', link: '/month/26/jun/d1' },
            { text: 'Day 2 - PIERNAS Y HOMBROS', link: '/month/26/jun/d2' },
            { text: 'Day 3 - ESPALDA Y TRICEPS', link: '/month/26/jun/d3' },
        ]
        },
        {
        text: '2026 - May',
        ...
        },
        {
            text: '2026 - April',
            items: [
                { text: 'Day 1 - PECHO Y BICEPS', link: '/month/26/apr/d1' },
                { text: 'Day 2 - PIERNAS Y HOMBROS', link: '/month/26/apr/d2' },
                { text: 'Day 3 - ESPALDA Y TRICEPS', link: '/month/26/apr/d3' },
            ]
        },
        {
            text: '2026 - March',
